...
describe('Dropshipping Module Tests', () => {
    ...
    describe('Order Push to Supplier', () => {
        const mockOrder = {
            id: 'ORD-12345',
            items: [
                { sku: 'NB-WIDGET-001', quantity: 2, price: 29.99 },
            ],
            customer: {
                name: 'Test Customer',
        ...
        it('should create SyncJob audit record for successful push', async () => {
            ...
            await pushOrderToSupplier(
                { ...mockOrder, id: 'ORD-AUDIT-TEST' },
                mockSupplier
            );
    ...
    describe('Performance and Scalability', () => {
        ...
        it('should handle pagination of margin rules', async () => {
            ...
            const page1 = await MarginRule.find({ vendorId })
                .limit(10)
                .skip(0);

            // Paginate: page 2 (10 items)
            const page2 = await MarginRule.find({ vendorId })
                .limit(10)
                .skip(10);
