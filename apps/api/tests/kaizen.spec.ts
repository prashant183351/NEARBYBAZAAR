...
describe('Kaizen API', () => {
    ...
    it('should create and link an experiment', async () => {
        ...
        const exp = await Experiment.create({ title: 'Experiment', ideas: [idea._id], status: 'Draft' });
    ...
    it('should create a decision and link to idea', async () => {
        ...
        const dec = await Decision.create({ title: 'Decision', idea: idea._id, madeBy: 'user3', madeAt: new Date() });
