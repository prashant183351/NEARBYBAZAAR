...
import { sendNotification, getUnreadCount, markAsRead, markAllAsRead } from '../src/services/notifications';
    ...
    describe('getUnreadCount', () => {
        it('returns correct unread count', async () => {
            await NotificationModel.create([
                { userId: vendorId, userType: 'vendor', type: 'order_received', title: 'A', message: 'A', read: false },
                { userId: vendorId, userType: 'vendor', type: 'order_received', title: 'B', message: 'B', read: false },
                { userId: vendorId, userType: 'vendor', type: 'order_received', title: 'C', message: 'C', read: true },
            ]);
    ...
    describe('markAllAsRead', () => {
        it('marks all notifications as read for a user', async () => {
            await NotificationModel.create([
                { userId: vendorId, userType: 'vendor', type: 'order_received', title: 'A', message: 'A', read: false },
                { userId: vendorId, userType: 'vendor', type: 'order_received', title: 'B', message: 'B', read: false },
                { userId: supplierId, userType: 'supplier', type: 'order_received', title: 'C', message: 'C', read: false },
            ]);
