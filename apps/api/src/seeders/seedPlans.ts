...
export async function seedPlansAndAssignments() {
    ...
    const plans = [
        ...
        { name: 'Pro', tier: 'Pro', maxListings: 20, features: ['featured', 'extra_images'], price: 100, currency: 'INR' },
        { name: 'Featured', tier: 'Featured', maxListings: 50, features: ['featured', 'extra_images'], price: 200, currency: 'INR' },
    ];
