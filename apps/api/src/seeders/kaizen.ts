...
export async function seedKaizenExamples() {
  ...
  const ideas = [
    {
      ...
      tags: ['UI', 'theme'],
      owners: [],
      description: 'Support dark mode for all users.',
    },
    {
      title: 'Improve onboarding',
      tags: ['UX'],
      owners: [],
      description: 'Make onboarding easier for new vendors.',
    },
  ];
  ...
  const decisions = [
    ...
    {
      title: 'Onboarding improvements scheduled',
      description: 'Onboarding flow will be improved next sprint.',
      madeBy: 'admin',
      madeAt: new Date(),
      immutable: true,
    },
