...
const SAMPLE_SKU_MAPPINGS = [
    ...
    { supplierEmail: 'alice@techwholesale.com', supplierSku: 'TW-LAPTOP-001', ourSku: 'NB-LAPTOP-DELL-XPS13', status: 'active' },
    { supplierEmail: 'alice@techwholesale.com', supplierSku: 'TW-LAPTOP-002', ourSku: 'NB-LAPTOP-HP-SPECTRE', status: 'active' },
    { supplierEmail: 'alice@techwholesale.com', supplierSku: 'TW-MOUSE-101', ourSku: 'NB-MOUSE-LOGITECH-MX3', status: 'active' },
    { supplierEmail: 'alice@techwholesale.com', supplierSku: 'TW-KEYBOARD-201', ourSku: 'NB-KEYBOARD-MECHANICAL-RGB', status: 'active' },
    { supplierEmail: 'alice@techwholesale.com', supplierSku: 'TW-MONITOR-301', ourSku: 'NB-MONITOR-4K-27INCH', status: 'active' },

    // Global Gadgets Supply products
    { supplierEmail: 'bob@globalgadgets.com', supplierSku: 'GG-PHONE-CASE-A12', ourSku: 'NB-CASE-IPHONE15-PRO', status: 'active' },
    { supplierEmail: 'bob@globalgadgets.com', supplierSku: 'GG-CHARGER-USB-C', ourSku: 'NB-CHARGER-USBC-65W', status: 'active' },
    { supplierEmail: 'bob@globalgadgets.com', supplierSku: 'GG-EARBUDS-PRO', ourSku: 'NB-EARBUDS-WIRELESS-ANC', status: 'active' },
    { supplierEmail: 'bob@globalgadgets.com', supplierSku: 'GG-SMARTWATCH-V2', ourSku: 'NB-WATCH-FITNESS-TRACKER', status: 'active' },
    { supplierEmail: 'bob@globalgadgets.com', supplierSku: 'GG-TABLET-10IN', ourSku: 'NB-TABLET-ANDROID-10INCH', status: 'active' },

    // Home & Garden Direct products
    { supplierEmail: 'carol@homegardenirect.com', supplierSku: 'HGD-PLANT-STAND-WOOD', ourSku: 'NB-PLANTSTAND-BAMBOO-3TIER', status: 'active' },
    { supplierEmail: 'carol@homegardenirect.com', supplierSku: 'HGD-GARDEN-TOOLS-SET', ourSku: 'NB-TOOLSET-GARDEN-10PC', status: 'active' },
    { supplierEmail: 'carol@homegardenirect.com', supplierSku: 'HGD-PLANTER-CERAMIC-LG', ourSku: 'NB-PLANTER-CERAMIC-LARGE', status: 'active' },
    { supplierEmail: 'carol@homegardenirect.com', supplierSku: 'HGD-WATERING-CAN-2GAL', ourSku: 'NB-WATERINGCAN-METAL-2GAL', status: 'active' },
    { supplierEmail: 'carol@homegardenirect.com', supplierSku: 'HGD-HOSE-EXPANDABLE-50FT', ourSku: 'NB-HOSE-EXPANDABLE-50FT', status: 'active' },
];
    ...
    try {
        ...
        for (const ruleData of SAMPLE_MARGIN_RULES) {
            ...
            if (existing) {
                ...
                updatedRules++;
                console.log(`  ↻ Updated: ${ruleData.description} (${ruleData.marginType}: ${ruleData.value})`);
            } else {
                // Create new rule
                ...
                createdRules++;
                console.log(`  ✓ Created: ${ruleData.description} (${ruleData.marginType}: ${ruleData.value})`);
            }
        }
