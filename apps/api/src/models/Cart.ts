 ...
 */
cartSchema.methods.addItem = async function (item: Omit<ICartItem, 'metadata'>): Promise<ICart> {
 ...
 */
cartSchema.methods.removeItem = async function (itemId: Types.ObjectId): Promise<ICart> {
