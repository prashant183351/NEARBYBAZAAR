...
const AgreementSchema = new Schema<Agreement>({
    type: { type: String, enum: ['sla', 'compliance', 'terms_of_service', 'privacy_policy'], required: true },
...
export const AgreementAcceptanceModel = model<AgreementAcceptance>('AgreementAcceptance', AgreementAcceptanceSchema);
