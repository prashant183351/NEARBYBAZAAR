            ...
            <table style={{ width: '100%', marginTop: 16, borderCollapse: 'collapse' }}>
                <thead>
                    <tr>
                        ...
                        <th style={{ textAlign: 'left', padding: 8, borderBottom: '2px solid #ddd' }}>Enabled</th>
                        <th style={{ textAlign: 'left', padding: 8, borderBottom: '2px solid #ddd' }}>Channels</th>
                        <th style={{ textAlign: 'left', padding: 8, borderBottom: '2px solid #ddd' }}>Aggregate</th>
                    </tr>
                </thead>
                <tbody>
                                ...
                                <td style={{ padding: 8 }}>
                                    <label>
                                        <input
                                            ...
                                            onChange={(e) => updatePreference(value, { aggregateEnabled: e.target.checked })}
                                        />
                                        Every
                                    </label>
                                    <input
                                        ...
                                        onChange={(e) => updatePreference(value, { aggregateIntervalMinutes: Number(e.target.value) })}
