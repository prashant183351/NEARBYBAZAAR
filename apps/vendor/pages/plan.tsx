...
export default function VendorPlanPage() {
  ...
  return (
    ...
    >
      ...
      <div>
        <strong>{plan.name}</strong> ({plan.tier})
      </div>
      <div>
        Listings used: {usage.listingsUsed} / {plan.maxListings}
      </div>
      <div
        style={{ background: '#eee', borderRadius: 4, height: 16, margin: '8px 0', width: '100%' }}
      >
        <div
          style={{ background: '#1fa463', height: '100%', width: `${quotaPct}%`, borderRadius: 4 }}
        />
      </div>
