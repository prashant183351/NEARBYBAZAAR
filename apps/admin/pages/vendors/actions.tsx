	...
	const handleOverride = async () => {
		...
		try {
			const response = await fetch(
				`/v1/vendor-actions/action/${overrideModal.actionId}/override`,
				{
					method: 'POST',
				...
				<div className="bg-white shadow rounded-lg p-6">
					<div className="flex justify-between items-center mb-4">
						<h2 className="text-xl font-semibold">
							Action History for {vendorHistory.vendor}
						</h2>
						<button
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
					<div className="bg-white rounded-lg p-6 max-w-md w-full">
						<h3 className="text-lg font-semibold mb-4">
							Override {overrideModal.actionType}
						</h3>
						<p className="text-sm text-gray-600 mb-4">
							Provide a detailed reason for overriding this action. This will restore the
							vendor to active status and log your decision.
						</p>
						<textarea
