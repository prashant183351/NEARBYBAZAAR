...
const erpFields = ['ERP_Order_ID', 'ERP_Customer_Name', 'ERP_Customer_Email', 'ERP_Items', 'ERP_Total', 'ERP_Date'];
...
export default function ERPFieldMappingPage() {
    ...
    return (
        <div style={{ maxWidth: 600, margin: '0 auto', padding: 32 }}>
            ...
            <button onClick={handlePreview} style={{ marginBottom: 16 }}>Preview Mapping</button>
            {preview && (
