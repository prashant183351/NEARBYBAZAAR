...
export default function ProductPage({ slug }: ProductPageProps) {
    ...
    const product = {
      slug,
      name,
      model3d: slug === 'chair-3d-demo' ? 'https://modelviewer.dev/shared-assets/models/Astronaut.glb' : undefined,
      arEnabled: true,
    ...
    return (
        <>
            ...
            <main style={{ padding: 32 }}>
                ...
                <p>Slug: {slug}</p>
                {product.model3d && (
                  <Product3DViewer modelUrl={product.model3d} ar={product.arEnabled} arMeta={product.arMeta} />
                )}
