    ...
    return (
        <>
            <head>
                ...
                <meta name="description" content="See the latest improvements and releases for NearbyBazaar." />
            </head>
                ...
                <ul style={{ listStyle: 'none', padding: 0 }}>
                    {decisions.map((d, i) => (
                        <li key={i} style={{ marginBottom: 24 }}>
                            ...
                            {d.version && <span style={{ color: '#888', marginRight: 8 }}>Version: {d.version}</span>}
                            <div style={{ color: '#666', marginBottom: 4 }}>{new Date(d.madeAt).toLocaleDateString()}</div>
